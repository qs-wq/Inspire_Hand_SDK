...
void RH56H1_485_Protocol::applyRegisterDecodeRule(const std::string& reg_name, std::vector<int>& values) const {
    ...
    static const std::set<std::string> kUnsignedRegs = {
        "angleAct",       "angleSet",        "speedSet",         "forceSet",          "currentAct",
        "currentSet",     "posAct",          "posSet",           "defaultSpeedSet",   "defaultForceSet",
        "mode",           "id",              "baudRate",         "clearError",        "save",
        "resetPara",      "gestureForceClb", "pause",            "stop",              "actionSeqIndex",
        "actionSeqRun",
    };
    ...
    if (version == 2) {
        try {
            ...
            static const FingerSeg kFingers[5] = {
                {3000, 3004, 3034}, {3040, 3044, 3074}, {3080, 3084, 3114},
                {3120, 3124, 3154}, {3160, 3164, 3194},
            };
