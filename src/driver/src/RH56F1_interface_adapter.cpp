        ...
        if (!tc.command_topic.empty() && !tc.write_registers.empty()) {
            ...
            if (tc.name == "angle_control") {
                maps_.subscribers[tc.command_topic] = this->makeGroupedSubscription<rh56f1_interfaces::msg::SetAngle1>(
                    tc.command_topic, 10, [this, reg, hid](rh56f1_interfaces::msg::SetAngle1::SharedPtr msg) {
                ...
                maps_.subscribers[tc.command_topic] = this->makeGroupedSubscription<rh56f1_interfaces::msg::SetForce1>(
                    tc.command_topic, 10, [this, reg, hid](rh56f1_interfaces::msg::SetForce1::SharedPtr msg) {
                        if (!rosIncomingHandIdTargetsThisNode(backend_, msg->hand_id)) {
                ...
                maps_.subscribers[tc.command_topic] = this->makeGroupedSubscription<rh56f1_interfaces::msg::SetSpeed1>(
                    tc.command_topic, 10, [this, reg, hid](rh56f1_interfaces::msg::SetSpeed1::SharedPtr msg) {
                        if (!rosIncomingHandIdTargetsThisNode(backend_, msg->hand_id)) {
                ...
                maps_.subscribers[tc.command_topic] =
                    this->makeGroupedSubscription<rh56f1_interfaces::msg::SetCurrent1>(
                        tc.command_topic, 10, [this, reg, hid](rh56f1_interfaces::msg::SetCurrent1::SharedPtr msg) {
                            if (!rosIncomingHandIdTargetsThisNode(backend_, msg->hand_id)) {
...
void RH56F1InterfaceAdapter::publishRegisterData(const TopicConfig& topic_config, const std::vector<int>& values) {
    const int32_t hid = backend_.ioHandId();
    rclcpp::Node* node = backend_.ioNode();
...
void RH56F1InterfaceAdapter::publishTouchData(const TopicConfig& topic_config, const TouchDataResult& touchData,
                                              int version) {
    (void)version;
    rclcpp::Node* node = backend_.ioNode();
        ...
        if (sc.is_write_register && !sc.set_service_name.empty()) {
            ...
            if (reg == "angleSet") {
                maps_.services[sc.set_service_name] = this->makeGroupedService<rh56f1_interfaces::srv::Setangle>(
                    sc.set_service_name, [this, reg](const rh56f1_interfaces::srv::Setangle::Request::SharedPtr req,
                ...
                maps_.services[sc.set_service_name] = this->makeGroupedService<rh56f1_interfaces::srv::Setid>(
                    sc.set_service_name, [this](const rh56f1_interfaces::srv::Setid::Request::SharedPtr req,
                ...
                maps_.services[sc.set_service_name] = this->makeGroupedService<rh56f1_interfaces::srv::Setmode>(
                    sc.set_service_name, [this](const rh56f1_interfaces::srv::Setmode::Request::SharedPtr req,
                ...
                maps_.services[sc.set_service_name] = this->makeGroupedService<rh56f1_interfaces::srv::Setforce>(
                    sc.set_service_name, [this](const rh56f1_interfaces::srv::Setforce::Request::SharedPtr req,
                ...
                maps_.services[sc.set_service_name] = this->makeGroupedService<rh56f1_interfaces::srv::Setspeed>(
                    sc.set_service_name, [this](const rh56f1_interfaces::srv::Setspeed::Request::SharedPtr req,
                ...
                maps_.services[sc.set_service_name] = this->makeGroupedService<rh56f1_interfaces::srv::Setbaudrate>(
                    sc.set_service_name, [this, reg](const rh56f1_interfaces::srv::Setbaudrate::Request::SharedPtr req,
                ...
                maps_.services[sc.set_service_name] = this->makeGroupedService<rh56f1_interfaces::srv::Setclearerror>(
                    sc.set_service_name,
                    [this, reg](const rh56f1_interfaces::srv::Setclearerror::Request::SharedPtr req,
                ...
                maps_.services[sc.set_service_name] =
                    this->makeGroupedService<rh56f1_interfaces::srv::Setgestureforceclb>(
                        sc.set_service_name,
                        [this, reg](const rh56f1_interfaces::srv::Setgestureforceclb::Request::SharedPtr req,
                ...
                maps_.services[sc.set_service_name] = this->makeGroupedService<rh56f1_interfaces::srv::Setdefaultspeed>(
                    sc.set_service_name,
                    [this, reg](const rh56f1_interfaces::srv::Setdefaultspeed::Request::SharedPtr req,
                ...
                maps_.services[sc.set_service_name] =
                    this->makeGroupedService<rh56f1_interfaces::srv::Setdefaultforceset>(
                        sc.set_service_name,
                        [this, reg](const rh56f1_interfaces::srv::Setdefaultforceset::Request::SharedPtr req,
                ...
                maps_.services[sc.set_service_name] = this->makeGroupedService<rh56f1_interfaces::srv::Setpause>(
                    sc.set_service_name, [this, reg](const rh56f1_interfaces::srv::Setpause::Request::SharedPtr req,
                ...
                maps_.services[sc.set_service_name] = this->makeGroupedService<rh56f1_interfaces::srv::Setstop>(
                    sc.set_service_name, [this, reg](const rh56f1_interfaces::srv::Setstop::Request::SharedPtr req,
                ...
                maps_.services[sc.set_service_name] =
                    this->makeGroupedService<rh56f1_interfaces::srv::Setactionseqindex>(
                        sc.set_service_name,
                        [this, reg](const rh56f1_interfaces::srv::Setactionseqindex::Request::SharedPtr req,
                ...
                maps_.services[sc.set_service_name] =
                    this->makeGroupedService<rh56f1_interfaces::srv::Setactionlibraryindex>(
                        sc.set_service_name,
                        [this, reg](const rh56f1_interfaces::srv::Setactionlibraryindex::Request::SharedPtr req,
                ...
                throw std::runtime_error("[RH56F1] 未映射的写寄存器服务: " + reg +
                                         "，请在 rh56f1_interfaces 增加专用 .srv 并接线");
            }
        }
        ...
        if (!sc.get_service_name.empty()) {
            ...
            if (reg == "errorCode") {
                maps_.services[sc.get_service_name] = this->makeGroupedService<rh56f1_interfaces::srv::Geterror>(
                    sc.get_service_name, [this](const rh56f1_interfaces::srv::Geterror::Request::SharedPtr req,
                ...
                maps_.services[sc.get_service_name] = this->makeGroupedService<rh56f1_interfaces::srv::Gettemp>(
                    sc.get_service_name, [this](const rh56f1_interfaces::srv::Gettemp::Request::SharedPtr req,
                ...
                maps_.services[sc.get_service_name] = this->makeGroupedService<rh56f1_interfaces::srv::Getstatus>(
                    sc.get_service_name, [this](const rh56f1_interfaces::srv::Getstatus::Request::SharedPtr req,
                ...
                throw std::runtime_error("[RH56F1] 未映射的读寄存器服务: " + reg +
                                         "，请在 rh56f1_interfaces 增加专用 .srv 并接线");
            }
        }
    }
